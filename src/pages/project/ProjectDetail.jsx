...
<div className="bg-radial-dark">
  ...
  <Wrapper direction="column" customClass="bg-radial-dark w-screen  min-h-max  ">
    <Line>DETAIL</Line>
    <h1 style={{ letterSpacing:'0.57em' }} className="text-font-200 header text-6xl mb-24 ">MENFESS KUY</h1>
    <Container customClass="bg-radial-dark" direction="column">
      ...
      {/* Thumbnail img */}
      <Wrapper customClass="mt-20 h-screen">
